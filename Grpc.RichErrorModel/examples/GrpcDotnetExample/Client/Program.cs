...
namespace REMDemoClient
{
	class ClientProgram
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                // First request should not return an error
            ...
            {
                // This should not be reached as no error is expected
                PrintStatusDetails(ex);
            }

            try
            {
                // Second request should return a simple error
            ...
            try
            {
                // Third request should return a more complex error
